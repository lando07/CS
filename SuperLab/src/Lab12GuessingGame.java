...
public class Lab12GuessingGame {
    ...
    public static void Lab12() {
        try {
            ...
            try { // int randNum = rand.nextInt(upperbound); //gives us our random
                  // number
                  // 0-100
                ...
                System.out.println("Thanks for playing!");// ending line to say goodbye, code is done and ends after
                                                          // this.
            } finally {
            }
        } finally {
