...
public class FullBlackjack {
    public static void main(String[] args) {
        ...
        Random rand = new Random(); // upperbound is 10 so it will choose numbers from 0-9 when assigning varibles a
        ...
        while (playAgain) {
            ...
            int dealerTotal;
            int hitOrStandNum;
            int num1 = rand.nextInt(10) + 2;// like said up above, to make it from 2 to 11, I add to to "shift" all the
                                            // values up by two
