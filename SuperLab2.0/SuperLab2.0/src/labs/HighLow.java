        ...
        try (Scanner console = new Scanner(System.in)) {
            ...
            while (playAgain) { // works if user is playing for the first time or wants to play again, loops
                ...
                if (randNum == 0) {
                    ...
                    while (tryAgain == 1) { // this is true from the start, but won't play until reached. asks user if
                        ...
                        if (yesOrNo.equals("Y") || yesOrNo.equals("y")) {
                            ...
                            tryAgain = 0;
                            System.out.print('\u000C');
                        } else { // this is a safeguard so nobody can troll the code, this while statement also
                                 // will run until they say Y or N
