...
/**
 *  The {Drw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  @author Kevin Wayne
 */
public final class Drw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static Drw std = new Drw();
     ...
     * {Drw.BLACK}, {Drw.BLUE}, {Drw.CYAN},
     * {Drw.DARK_GRAY}, {Drw.GRAY}, {Drw.GREEN},
     * {Drw.LIGHT_GRAY}, {Drw.MAGENTA}, {Drw.ORANGE},
     * {Drw.PINK}, {Drw.RED}, {Drw.WHITE}, and
     * {Drw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Drw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
            URL url = Drw.class.getResource(filename);
            if (url != null)
                icon = new ImageIcon(url);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        FileDialog chooser = new FileDialog(Drw.frame, "Use a .png or .jpg extension", FileDialog.SAVE);
        chooser.setVisible(true);
        String filename = chooser.getFile();
        if (filename != null) {
            Drw.save(chooser.getDirectory() + File.separator + chooser.getFile());
        }
    }
    ...
    public void mousePressed(MouseEvent e) {
        synchronized (mouseLock) {
            mouseX = Drw.userX(e.getX());
            mouseY = Drw.userY(e.getY());
            isMousePressed = true;
        }
    }
    ...
    public static void main(String[] args) {
        Drw.square(0.2, 0.8, 0.1);
        Drw.filledSquare(0.8, 0.8, 0.2);
        Drw.circle(0.8, 0.2, 0.2);

        Drw.setPenColor(Drw.BOOK_RED);
        Drw.setPenRadius(0.02);
        Drw.arc(0.8, 0.2, 0.1, 200, 45);

        // draw a blue diamond
        Drw.setPenRadius();
        Drw.setPenColor(Drw.BOOK_BLUE);
        double[] x = { 0.1, 0.2, 0.3, 0.2 };
        double[] y = { 0.2, 0.3, 0.2, 0.1 };
        Drw.filledPolygon(x, y);

        // text
        Drw.setPenColor(Drw.BLACK);
        Drw.text(0.2, 0.5, "black text");
        Drw.setPenColor(Drw.WHITE);
        Drw.text(0.8, 0.8, "white text");
    }
}
